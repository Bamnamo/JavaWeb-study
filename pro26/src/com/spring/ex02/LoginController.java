...
public class LoginController {
	...
	public ModelAndView loginForm(HttpServletRequest request, HttpServletResponse respoonse) throws Exception {
	 ...
	 * userName); System.out.println("email: "+email); mav.addObject("userID",
	 * userID); mav.addObject("userName", userID); return mav; }
	 * 
	 * 
	 * @RequestMapping(value = "/test/login3.do", method = { RequestMethod.GET,
	 * RequestMethod.POST }) public ModelAndView login3(@RequestParam Map<String,
	 * String> info, HttpServletRequest request, HttpServletResponse response)
	 * throws Exception { request.setCharacterEncoding("utf-8"); ModelAndView mav =
	 * new ModelAndView(); String userID = info.get("userID"); String userName =
	 * info.get("userNmae"); System.out.println("userID: " + userID);
	 * System.out.println("userName: " + userName); mav.addObject("info", info);
